...
def main():
    ...
    parser.add_argument('--image_dir', default='/data/lingoqa/val/ori')
    parser.add_argument('--scene', default='gt_asd_total.json')
    parser.add_argument('--rules', type=str, default='uk_rules1004.json')
    ...
    for seg_id, scene in scenes.items():
        ...
        for it in it_list:
            ...
            if False: # disable the intention check
